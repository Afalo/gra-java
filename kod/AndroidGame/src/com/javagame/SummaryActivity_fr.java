...
public class SummaryActivity_fr extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_summary_fr);
		...
		String newInfo = getResources().getText(R.string.goodQuestionCount_fr) + " " + goodQuestionCount + "/" + questionCount + " " + getResources().getText(R.string.question_fr);
		info.setText(newInfo);
		if(music==true){
			mp = MediaPlayer.create(SummaryActivity_fr.this, R.raw.fr);
			mp.start();
		}

		if(goodQuestionCount<=5){
			TextView info1 = (TextView) findViewById(R.id.textView1);
			String newInfo1 = "MALHEUREUSEMENT...";
			info1.setText(newInfo1);
		}
		else{
			TextView info2 = (TextView) findViewById(R.id.textView1);
			String newInfo2 = "FELICITATIONS!!";
